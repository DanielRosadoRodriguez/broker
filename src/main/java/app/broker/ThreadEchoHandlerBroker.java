        ...
        try {
            ...
            * */
            ...
            if(typeService.equals("registrar")){
                ...
                TEHBrokerServerRequest tehBrokerServerRequestVotar =
                        new TEHBrokerServerRequest(1013, "127.0.0.1", jsonObject);
                ...
                TEHBrokerServerRequest tehBrokerServerRequestContar =
                        new TEHBrokerServerRequest(1013, "127.0.0.1", requestJsonFromClient);
